...
**Status:** Mandatory path complete through SH-017. Bonus SH-018 (Ctrl+C) is done. Next bonuses: prompt cwd, history, etc.

18 Done, 6 To Do, 0 In Progress, 0 In Review, 3 Backlog.
