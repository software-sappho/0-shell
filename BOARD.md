...
| [SH-009](./SH-009-cat.md) | `cat` | P1 | fs-read | @andriana |
...
| [SH-013](./SH-013-cp.md) | `cp` | P1 | fs-write | @andriana |
...
| [SH-020](./SH-020-bonus-history.md) | Command history (bonus) | P2 | bonus | @andriana |
