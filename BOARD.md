...
**Status:** All mandatory Phase 2 commands through SH-015 (`rm` / `rm -r`) are done. Next up is SH-016 (audit dry-run), then docs. Bonus track still optional.

15 Done, 9 To Do, 0 In Progress, 0 In Review, 3 Backlog.
