...
**Status:** Mandatory path complete through SH-017. Bonuses SH-018 (Ctrl+C) and SH-019 (cwd prompt) are done. Next: history, env vars, etc.

19 Done, 5 To Do, 0 In Progress, 0 In Review, 3 Backlog.
